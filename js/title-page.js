...
(function(factory) {
    ...
    var TitleOverlayPlugin = function(player, options) {
        ...
        var createOverlayContainer_ = function() {
            ...
            this.titleOverlayTextContainer.textContent = options.title.substr(0, 150).concat(options.title.length > 150 ?' ...': '') || title_defaults.title.substr(0, 150).concat(options.title.length > 150 ?' ...': '');
        ...
        var updateTitle_ = function(titleText) {
            ...
            var meTitleText = titleText.substr(0, 150);
            this.titleOverlayTextContainer.textContent = meTitleText;
        }.bind(this);
